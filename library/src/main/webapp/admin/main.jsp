...
<head>
    ...
    <script type="text/javascript">
        ctx = '${pageContext.servletContext.contextPath}';
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li id="admin-index">
                    <a href="${pageContext.request.contextPath}/admin/main.jsp" target="ireame">
                        <i class="fa fa-dashboard"></i> <span>首页</span>
                    </a>
                </li>
                <!-- 人员管理 -->
                <li id="admin-login">
                    <a href="${pageContext.request.contextPath}/users/search" target="iframe">
