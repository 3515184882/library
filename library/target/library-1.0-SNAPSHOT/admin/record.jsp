    ...
    <div class="box-tools pull-right">
        <div class="has-feedback">
            <form action="${pageContext.request.contextPath}/record/searchRecords" method="post">
                <c:if test="${USER_SESSION.userRole =='ADMIN'}">
                    借阅人：<input name="recordBorrower" value="${search.recordBorrower}">&nbsp&nbsp&nbsp&nbsp
                </c:if>
                图书名称：<input name="recordBookname" value="${search.recordBookname}">&nbsp&nbsp&nbsp&nbsp
...
<script>
    ...
    recordVO.recordBookname = "${search.recordBookname}"
    recordVO.recordBorrower = "${search.recordBorrower}"
    /*分页效果*/
    pagination(pageargs);
</script>
</html>
